...
type CategoryController struct{ DB *bun.DB }

func (cc *CategoryController) Index(res *goyave.Response, req *goyave.Request) {
...
func (cc *CategoryController) Show(res *goyave.Response, req *goyave.Request) {
