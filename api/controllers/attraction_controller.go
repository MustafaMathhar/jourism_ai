...
type AttractionController struct{ DB *bun.DB }

func (ac *AttractionController) Index(res *goyave.Response, req *goyave.Request) {
...
func (ac *AttractionController) Show(res *goyave.Response, req *goyave.Request) {
